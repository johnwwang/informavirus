  ...
  <q-page>
    <div class="q-pa-md text-center">
      <p style="font-size: 300%">
        <strong>Do you display symptoms?</strong>
      </p>
      <p>
        <em>If you select yes, you will have the option to track your location</em>
      </p>
    </div>
    <br />
              ...
              >
                <q-tab-panel name="innerCheck">
                  <div
                    ...
                    class="q-pa-xl row items-start q-gutter-md"
                  >
                    <q-btn
                      class="qbutton"
                      @click="FhandlerYes()"
    ...
    <div class="q-pa-md absolute-bottom-right">
      <q-btn round icon="warning" size="20px" color="black" />
    </div>
